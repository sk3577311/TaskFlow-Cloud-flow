...
def enqueue_job(job_id: str, priority: str = "medium"):
    """Add job to Redis sorted set with priority-based score."""
...
def dequeue_job() -> str | None:
    """Fetch next job based on priority (lowest score first)."""
